function SaveSettings(Settings)
    ...
    if file then
        ...
        file:write("AudioRaw=".. tostring(Settings.NoteSpeedRaw) .. "\n")
        file:write("AudioPercent=".. tostring(Settings.NoteSpeedPercent) .. "\n")
        file:write("TimerBox=".. tostring(Settings.TimerBox) .. "\n")
...
function LoadSettingsIO(Settings)
    ...
    if file then
        ...
        line=file:read("*l")
        Settings.NoteSpeedRaw=tonumber(line:match("=(.+)"))
        line=file:read("*l")
        Settings.NoteSpeedPercent=tostring(line:match("=(.+)"))
        line=file:read("*l")
        Settings.TimerBox=toboolean(line:match("=(.+)"))
        line=file:read("*l")
